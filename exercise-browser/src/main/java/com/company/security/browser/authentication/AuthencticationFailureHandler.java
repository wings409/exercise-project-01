...
/**
 * @ClassName AuthencticationFailureHandler
 * @Description: TODO: 自定义登录失败处理
 * @Author qiqinbo
 * @Date 2020/6/2 21:54
 * @Version V1.0
 **/
@Component("AuthenctiationFailureHandler")
public class AuthencticationFailureHandler extends SimpleUrlAuthenticationFailureHandler{
